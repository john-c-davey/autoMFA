...
MFA_ECM <- function(Y, gmin = 1, gmax =10, qmin = 1, qmax = NULL, eta = 0.5e-2 ,itmax = 500, nkmeans = 5, nrandom = 5, tol = 1e-05,
  ...
  #f_call = paste0("Call: MFA_ECM(Y, gmin = ", gmin ,", gmax = ",gmax,", qmax = ",qmax,", eta = ", eta,'\n', ", itmax = ", itmax, ", nkmeans = ", nkmeans, ", nrandom = ", nrandom, ", tol = ", tol, ", conv_measure = ",  conv_measure ,", varimax = ", varimax, ")")
  f_call = match.call()
